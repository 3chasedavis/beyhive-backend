...
struct Outfit: Identifiable {
    ...
    let date: String
    let location: String
    let imageName: String // Use asset name or system image
}

struct OutfitTrackerView: View {
    let outfits: [Outfit] = [
        Outfit(name: "White Fringed Mugler", date: "Apr 28, 2025", location: "Los Angeles, SoFi Stadium", imageName: "tshirt.fill"),
        Outfit(name: "Blinged Denim Cavalli", date: "Apr 28, 2025", location: "Los Angeles, SoFi Stadium", imageName: "jeans"),
        Outfit(name: "Green Checked Burberry", date: "Apr 28, 2025", location: "Los Angeles, SoFi Stadium", imageName: "leaf.fill"),
        Outfit(name: "All-White Versace Chaps", date: "Jun 5, 2025", location: "London, Tottenham Stadium", imageName: "snow"),
        Outfit(name: "Red/White Moschino Catsuit", date: "May 22, 2025", location: "New Jersey, MetLife Stadium", imageName: "flame.fill"),
        Outfit(name: "LED Dress Anrealage", date: "May 1, 2025", location: "Los Angeles, SoFi Stadium", imageName: "lightbulb.fill"),
        Outfit(name: "Custom Off-White", date: "May 15, 2025", location: "Chicago, Soldier Field", imageName: "circle.hexagongrid.fill"),
        Outfit(name: "Custom Loewe", date: "May 1, 2025", location: "Los Angeles, SoFi Stadium", imageName: "star.fill"),
        Outfit(name: "Custom Burberry", date: "May 22, 2025", location: "New Jersey, MetLife Stadium", imageName: "leaf"),
    ]
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            Text("Last Worn - Los Angeles, SoFi Stadium")
                .font(.headline)
                .foregroundColor(.gray)
                .padding(.top, 24)
                .padding(.horizontal)
            // Horizontal timeline of outfits
            ...
            ScrollView(.horizontal, showsIndicators: false) {
                HStack(spacing: 12) {
                    ForEach(["All", "White", "Denim", "Green", "Red", "LED", "Chaps"], id: \ .self) { filter in
                        Text(filter)
            ...
            ScrollView {
                VStack(spacing: 0) {
                    ForEach(outfits) { outfit in
                        HStack(spacing: 16) {
                            ZStack {
                                RoundedRectangle(cornerRadius: 12).fill(Color(.systemGray6)).frame(width: 54, height: 54)
                                Image(systemName: outfit.imageName)
                                    .resizable()
                                    .scaledToFit()
                                    .frame(width: 36, height: 36)
