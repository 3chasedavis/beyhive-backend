...
if (!admin.apps.length) {
  try {
    ...
    if (process.env.FIREBASE_PROJECT_ID && process.env.FIREBASE_PRIVATE_KEY) {
      ...
      console.log('Firebase Admin SDK initialized for Android notifications (env vars)');
    } else {
      ...
      console.log('Firebase Admin SDK initialized for Android notifications (local file)');
    }
  } catch (error) {
